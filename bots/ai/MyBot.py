...
try:
    ...
    while True:
        ...
        output_vector = list(model.predict(np.array([input_vector]))[0])
        #output_vector = [output_vector[0]*0.1 + new_output_vector[0]*0.9,
                        #output_vector[1]*0.1 + new_output_vector[1]*0.9]
