...
class Game:
    ...
    @staticmethod
    def _set_up_logging(tag, name, debug_level):
        """
        ...
        logging.basicConfig(filename=log_file, level=debug_level, filemode='w')
        logging.info("Initialized bot {}".format(name))

        return logging.getLogger().name

    def __init__(self, name, debug_level=logging.INFO):
        """
        ...
        self.logger = Game._set_up_logging(tag, name, debug_level)
