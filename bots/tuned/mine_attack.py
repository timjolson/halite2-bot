...
game = hlt.Game("MineFirstAskQuestionsLater", logging.INFO)
...
try:
    while True:
        ...
        for ship in S.my.undocked:
            ...
            #logging.info(closest_empty_planets)
            #logging.info(closest_enemy_ships)
            ...
            if len(closest_empty_planets)>0:
                ...
                dist, enemy = closest_enemy_ships[0]
                enemy = enemy[0]
                navigate_command = ship.navigate(
                    enemy, game_map, P.all+S.my.all+obstacles, speed=MAX_SPEED, ignore_ships=True)
                if navigate_command:
                    command_queue.append(navigate_command)
