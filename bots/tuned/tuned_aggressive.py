...
try:
    ...
    while True:
        ...
        timeout_lim = 1.975 - len(my_ships)/800
        ...
        for ship in my_ships:
            ...
            closest_friendly = game_map.nearby_entities_by_distance(ship, my_ships)[:5,1]
            ...
            if target:
                ...
                if ship.can_dock(target):
                    ...
                    navigate_command = ship.navigate(
                        ...
                        target,
                        game_map,
                        obstacles+closest_friendly+all_planets,
                        speed=speed,
                        angular_step=1)
                ...
                if target:
                    ...
                    navigate_command = ship.navigate(
                        target, game_map, all_planets+closest_friendly, speed=MAX_SPEED)
                    if navigate_command:
                        command_queue.append(navigate_command)
